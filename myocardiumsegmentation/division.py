...
def division():
    ...
    # make the left myocardium a closed loop
    ...
    segmentation.GetSegment(thick_wall_id).SetColor(COLOUR_GREEN)
    ...
    set_segments_visibility(segmentation_node, segmentation, [thin_wall_id, thick_wall_id], volume_node)
