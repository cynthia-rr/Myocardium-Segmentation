import os
import slicer
from SegmentationConstants import *

PATH_TO_DATASET = os.path.expanduser("~/Downloads/datasets/Totalsegmentator_dataset_v201/s0738/ct.nii.gz")

#### Initialisation and setup ####

# Load image, get Volume node
volumeNode = slicer.util.loadVolume(PATH_TO_DATASET)
print("Loaded dataset from: ", PATH_TO_DATASET)
